        ...
        methods: {
            ...
            saveData() {
                ...
                axios.post(path, this.data)
                    .then(() => {
                        this.$router.push({name: 'books.index', resource: this.$route.params.resource});
                        this.$notify({
                            group: 'app',
                            type: 'success',
                            title: 'Success',
                            text: 'Book has created successfully.'
                        });
                    })
                    .catch((error) => {
                        let response = error.response;
                        let message = 'An error occurred. Book has not been saved.';
